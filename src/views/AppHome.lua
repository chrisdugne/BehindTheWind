...
function scene:refreshScene()
	...
	viewManager.buildButton(menu, "", "white", 21, display.contentWidth/2, 	display.contentHeight*0.5, 	function() router.openLevelSelection() end)
...
function scene:enterScene( event )
	if(introComplete) then
		...
		if(not GLOBALS.savedData.fullGame and not SIMULATOR) then
			self:openMoreGames()
   	end
	end
end
